        ...
        <div className=' w-full p-2 md:p-12 md:pt-3'>
            ...
            <div className="grid md:grid-cols-[40%_60%] md:gap-20 items-start">
                <div className=" justify-center text-center bg-linear-to-br from-[#966d35] to-[#2e1f03] rounded-2xl">
                    <div className="max-w-md mx-auto my-15 md:my-25">
                        ...
                        <h1 className='text-3xl font-bold text-white'>Akses Dukungan Langsung</h1>
                        <p className='my-7 text-[#beb7a9] '>Klik tombol di bawah untuk diarahkan langsung ke meja dukungan institusional kami melalui WhatsApp untuk bantuan berkecepatan tinggi.</p>
                        <a href="https://regol.kbvalbury.com/#/register/MM03" className='font-bold mt-5 p-5 px-15 bg-[#f5b11d] hover:bg-[#c78800] text-black inline-flex '><span><PaperPlaneRightIcon className='mt-1 mr-2' /></span> HUBUNGI VIA WHATSAPP</a>

                    </div>
                </div>
                <div className="grid grid-cols-1 md:max-w-3xl gap-8 my-12 md:my-0">
                    <div className="bg-[#e9e9e9] dark:bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-6">
                    ...
                    <div className="bg-[#e9e9e9] dark:bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-6 grid grid-cols-1 gap-6 ">
                        <div className="">
